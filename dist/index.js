...
const progress_stream = __toESM(require("progress-stream"));
const tar = __toESM(require("tar"));
const unzipper = __toESM(require("unzipper"));
...
async function resolveDownloadOptions(options) {
	...
	return {
		...options,
		url,
		requester: options.requestType === "http" ? node_http.default : node_https.default
	};
}
...
function createTarUnzipStream(options) {
	const count = (0, alien_signals.signal)(0);
	const passThrough = new node_stream.default.PassThrough();
...
async function download(options) {
	...
	return new Promise((resolve, reject) => {
		...
		resolvedOptions.requester.get(requestOptions, (response) => {
			...
			const progressStream = (0, progress_stream.default)({
				length: totalSize,
				time: 100
			...
			if (!node_fs.default.existsSync(options.tarCacheDir)) node_fs.default.mkdirSync(options.tarCacheDir, { recursive: true });
...
exports.SdkArch = SdkArch;
exports.SdkOS = SdkOS;
exports.SdkVersion = SdkVersion;
exports.download = download;
exports.getSdkUrl = getSdkUrl;
exports.getSdkUrls = getSdkUrls;
