...
describe.sequential('should download the SDK', (it) => {
  it.sequential('should download the SDK API10', async ({ expect }) => {
  ...
  it.sequential('should download the SDK API11', async ({ expect }) => {
  ...
  it.sequential('should download the SDK API12', async ({ expect }) => {
  ...
  it.sequential('should download the SDK API13', async ({ expect }) => {
  ...
  it.sequential('should download the SDK API14', async ({ expect }) => {
  ...
  it.sequential('should download the SDK API15', async ({ expect }) => {
  ...
  it.sequential('should download the SDK API18', async ({ expect }) => {
